...
JOBS_PATH = Path("./brainreg_fiber/jobs")  # Stores SLURM scripts and logs
...
REGISTRATION_CHANNEL = (
    3  # this is the channel we want to register to; green is less flourescent than red and less noisy than blue.
)

...
def plot_prop_optimal(
    ...
    """
    df = _filter_navigation_df(navigation_strategies_df, stim_day_range, stim_only, decision_points_only)
...
def plot_prop_scenarios(
    ...
    """Plot P(optimal choice) on two scenarios defined as conjunctions of strategy-agreement constraints.
...
def _filter_navigation_df(navigation_strategies_df, stim_day_range, stim_only, decision_points_only):
